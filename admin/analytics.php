...
<script>
      <?php
            ...
            $female=$ro2['count'];
            $male=$row['count'];
            $q3="SELECT count(*) as count FROM food_donations where location=\"Bhaktapur\"";
            $res3=mysqli_query($connection, $q3);
            $ro3=mysqli_fetch_assoc($res3);
            $Bhaktapur=$ro3['count'];
            $q4="SELECT count(*) as count FROM food_donations where location=\"kathmandu\"";
...
var xplace=["Bhaktapur","Lalitpur","Kathmandu"];
var yplace=[<?php echo json_encode($Bhaktapur,JSON_HEX_TAG);?>,<?php echo json_encode($Lalitpur,JSON_HEX_TAG);?>,<?php echo json_encode($Kathmandu,JSON_HEX_TAG);?>, 20];
