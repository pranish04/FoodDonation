...
<body style="    background-color: #06C167;">
    ...
    <form action="" method="post">
       ...
       <div class="input">
        ...
        <div class="input">
        <label for="quantity">Quantity:(kg or plates)</label>
      ...
      <input type="text" id="name" name="name"value="<?php echo"". $_SESSION['name'] ;?>" readonly required/>
      </div>
      <div>
        <label for="phoneno" >PhoneNo:</label>
        <input type="text" id="phoneno" name="phoneno" maxlength="10" pattern="[0-9]{10}" value="<?php echo $_SESSION['phoneno'] ?? ''; ?>" readonly required />
      </div>
      </div>
        <div class="input">
