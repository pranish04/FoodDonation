...
const prompts = [
    ...
    ["how to donate food", "what are the steps to donate food"],
  ...
  const replies = [
    ...
    ["first click on donate in home page then fill the details and finally click on submit"],
    ...
    ["joke ha ha .."],
    [""],
    ["You can package your cooked or raw food donations in airtight containers such as plastic bags. You can also use aluminum foil or cling wrap to keep the food fresh. Please make sure to label the containers with the type of food, date, and any relevant instructions"],
